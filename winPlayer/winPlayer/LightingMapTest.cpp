...
LightingMapTest::LightingMapTest(const unsigned int width, const unsigned int height)
{
	nWidth = width;
	nHeight = height;
}

void LightingMapTest::showTest(GLFWwindow *window)
{
	...
	// ------------------------------------
	Shader lightingShader("res/shader/LightingMap.vs", "res/shader/LightingMap.fs");
